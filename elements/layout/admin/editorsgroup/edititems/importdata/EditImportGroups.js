...
export default class EditCustomers extends Wprr.BaseObject {
	
	/**
	 * Constructor
	 */
	_construct() {
		//console.log("EditCustomers::constructor");
		...
		
		{
			...
			column.setElement(<div>
				<Wprr.Link href={Wprr.sourceCombine(Wprr.sourceReference("projectLinks", "wp/site/admin/import-groups/import-group/"), "?id=", Wprr.sourceReference("item", "id"))}>
...
<div>
	...
	<div className="operations">
		<Wprr.SelectItem id="batchEdit/customers" as="batchEdit">
			<div>
