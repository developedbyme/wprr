...
export default class EditGlobalItems extends Wprr.BaseObject {
  ...
  value: Wprr.sourceReference("valueEditor", "valueSource")
		...
		
		{
			...
			column.setElement(React.createElement("div", null, /*#__PURE__*/React.createElement(Wprr.layout.admin.editorsgroup.editors.SelectAnyRelation, {
  direction: "outgoing",
...
}, Wprr.idText("Global items", "site.globalItems")), /*#__PURE__*/React.createElement("div", {
  className: "operations"
}, /*#__PURE__*/React.createElement(Wprr.SelectItem, {
  id: "batchEdit/globalItems",
  as: "batchEdit"
