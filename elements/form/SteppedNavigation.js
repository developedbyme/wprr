...
export default class SteppedNavigation extends WprrBaseObject {
	...
	_callback_change(aEvent) {
		//console.log("wprr/elements/form/SteppedNavigation::_callback_change");
		//console.log(aEvent);
	...
	_renderMainElement() {
		...
		let staticMarkup = React.createElement(Wprr.ReferenceInjection, {"injectData": injectData}, 
		...
		return React.createElement("div", {"className": "stepped-navigation-holder"},
			React.createElement(Wprr.ReferenceInjection,
				{"injectData": {
					"steppedNavigation": this,
					"steppedNavigation/externalStorage": this._externalStorage
