...
export default class EditRepresentationTypes extends Wprr.BaseObject {
  ...
  dataType: "type/representation-type,type",
  ...
  operationSections: operationSections
	...
	static getWpAdminEditor() {
		...
		let dataSettings = {
			"items": {
				"value": "wprr/v1/range/dbm_data/drafts,privates,relation/status,fields,editObjectRelations?type=type/representation-type",
				"replacements": {}
			}
		};
