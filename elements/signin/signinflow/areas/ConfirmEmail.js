...
export default class ConfirmEmail extends Layout {
	...
	_sendEmail() {
		...
		let loader = project.getActionLoader("send-email-verification");
	...
	_resendEmail() {
		...
		let loader = project.getActionLoader("resend-email-verification");
		let email = this.getReference("externalStorage", "email");
	...
	_checkCode(aCode) {
		...
		let loader = project.getActionLoader("verify-email");
		let email = this.getReference("externalStorage", "email");
...
})), /*#__PURE__*/React.createElement("span", null, Wprr.idText("Email verified", "site.emailVerified")))))), /*#__PURE__*/React.createElement("div", {
  className: "spacing standard"
