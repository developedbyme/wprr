...
export default class EditRequestMethods extends Wprr.BaseObject {
  ...
  dataType: "type/request-method,type",
  ...
  operationSections: operationSections
	...
	static getWpAdminEditor() {
		...
		let dataSettings = {
			"items": {
				"value": "wprr/v1/range/dbm_data/drafts,privates,relation/status,fields,editObjectRelations?type=type/request-method",
				"replacements": {}
			}
		};
