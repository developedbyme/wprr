...
export default class BigSelections extends Layout {
	...
	_getLayout(aSlots) {
		...
		let defaultLoopItem = React.createElement(Wprr.CommandButton, {commands: Wprr.commands.setValue(externalStorageSource, valueNameSource, itemValueSource)},
			React.createElement(Wprr.Adjust, {adjust: Wprr.adjusts.condition(valueSource, itemValueSource, "===", "active"), sourceUpdates: valueSource},
