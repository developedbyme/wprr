	...
	_renderMainElement() {
		...
		return <div>
			<Wprr.AddReference data="publish" as="publishStatus">
				<Wprr.layout.items.batch.BatchEditItems dataType="settings/data-source/loaded-data-source,settings/data-source,settings,named-item" searchFields="fieldByName.name.field.value" taxonomiesToLoad="dbm_relation" title={title} fields={fields} cellTypes={areas} operationSections={operationSections} />
			</Wprr.AddReference>
		</div>;
	}
