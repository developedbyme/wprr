...
export default class EditGroups extends Wprr.BaseObject {
	...
	_construct() {
		...
		
		{
			...
			column.setElement(<div>
				<Wprr.layout.admin.editorsgroup.editors.OrderedRelations direction="incoming" relationType="in" objectType="*" />
				<div className="spacing small" />
				<Wprr.FlexRow>
					<Wprr.layout.admin.editorsgroup.editors.AddRelation direction="incoming" relationType="in" objectType="*" />
				</Wprr.FlexRow>
			</div>);
		}
		
		{
			...
			column.setElement(<div>
				<Wprr.layout.admin.editorsgroup.editors.SelectType objectType="type/group-type" />
			</div>);
		}
...
<div>
	<h2 className="no-margins">{Wprr.idText("Groups", "site.groups")}</h2>
	<div className="operations">
		<Wprr.SelectItem id="batchEdit/groups" as="batchEdit">
			<div>
